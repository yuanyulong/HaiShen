...
string User_Item::toString()
{
	...
	return this->user_id+" "+this->item_id+","+this->item_category+","+string(str_buy_count)+","+string(str_workday_buy_count)+","+string(str_weekend_buy_count)+","+string(str_festival_buy_count)+"\r\n";
}
